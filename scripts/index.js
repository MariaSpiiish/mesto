...
popupPictureElement.addEventListener('mousedown', onOverlayClick);
popupProfileElement.addEventListener('mousedown', onOverlayClick);
popupPlaceElement.addEventListener('mousedown', onOverlayClick);
